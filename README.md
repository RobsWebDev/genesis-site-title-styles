...
This plugin adds a span tag to each word in the site title. Words need to be separated by a space. You can style each word using css and targeting the span with the nth-child() selector. 
